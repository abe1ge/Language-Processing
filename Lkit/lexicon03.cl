(build-lexicon
 '((we         determiner   (sems . all)            (numb . plur))
   ...
   (blue       adj          (sems . (colour . blue)))
   (green      adj          (sems . (colour . green)))
   (red        adj          (sems . (colour . red)))
   (yellow     adj          (sems . (colour . yellow)))
   (pink       adj          (sems . (colour . pink)))
   (great       adj         (sems . (descriptive . great)))
  ))